...
try
{
    ...
    builder.Services.AddDbContext<MySqlDBContext>(o =>
    o.UseMySql(builder.Configuration.GetConnectionString("MySQLConnection"),
        ServerVersion.Parse("8.0.34-mysql"), mySqlOptionsAction: options => { options.EnableRetryOnFailure(maxRetryCount: 5); }));
